package com.example.spring_h2;

import com.example.spring_h2.entities.Patient;
import com.example.spring_h2.repositories.PatientRepository;
...
public class SpringH2Application implements CommandLineRunner {
    @Autowired
    ...
    public void run(String... args) throws Exception {
        ...
        for (int i=0;i<100;i++){
            patientRepository.save(
                    new Patient(null, "Hassan",new Date(),
